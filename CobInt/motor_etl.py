...
def procesar_estado(id_estado_str, nombre_estado, nombre_pestana_coneval):
    ...
    ruta_inegi = "iter_00_cpv2020_csv/iter_00_cpv2020/conjunto_de_datos/conjunto_de_datos_iter_00CSV20.csv"
    df_inegi = pd.read_csv(ruta_inegi, dtype={'ENTIDAD': str, 'MUN': str, 'LOC': str}, low_memory=False)
